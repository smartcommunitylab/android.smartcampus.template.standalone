...
public class InfoDialogMultiEvent extends DialogFragment {
	...
	public void onStart() {
	    ...
	    final EventsArrayAdapter adapter = new EventsArrayAdapter(context,
	            android.R.layout.simple_list_item_1,  new ArrayList(data));
	  ...
	  private class EventsArrayAdapter extends ArrayAdapter<BaseDTObject> {
		    ...
		    public View getView(final int position, View convertView, ViewGroup parent) {
		         ...
		         line.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						getDialog().dismiss();
						new InfoDialogSingleEvent().newInstance((BaseDTObject)(data.toArray())[position]).show(getActivity().getFragmentManager(), "me");
					}
				});
		         return convertView;
