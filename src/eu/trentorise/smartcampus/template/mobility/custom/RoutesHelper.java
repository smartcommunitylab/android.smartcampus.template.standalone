...
public class RoutesHelper {
	...
	public static List<SmartLine> getSmartLines(Context ctx, String agencyId) {
		...
		if (agencyId == AGENCYID_BUS_TRENTO) {
			...
			// colors =
			// resources.obtainTypedArray(R.array.smart_check_12_colors);
			...
			// colors =
			// resources.obtainTypedArray(R.array.smart_check_16_colors);
			...
			// icons = resources.obtainTypedArray(R.array.smart_check_12_icons);
			// colors =
			// resources.obtainTypedArray(R.array.smart_check_17_colors);
		} else {
		...
		Collections.sort(routes, MobilityHelper.getRouteComparator());
		...
		for (int index = 0; index < lines.length; index++) {
			...
			SmartLine singleLine = new SmartLine(null, (linesNames != null ? linesNames.getString(index) : line), 0,
